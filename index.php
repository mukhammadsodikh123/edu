...
if ($blogs->num_rows > 0) {
  ...
  $order_class_2 = "order-md-2";
  $order_class_1 = "order-md-1";
      }else{
        $order_class_2 = "";
        $order_class_1 = "";
      }
        ...
        <div class='row featurette'>
          <div class='col-md-7 $order_class_2'>
            <h2 class='featurette-heading fw-normal lh-1'>$text</h2>
            <p class='lead'>$content</p>
          </div>
          <div class='col-md-5 $order_class_1'>
